...
var grammar = {
    ...
    {"name": "main", "symbols": ["table_list"], "postprocess": id},
    {"name": "table_list$ebnf$1$subexpression$1", "symbols": ["ws", "table"], "postprocess": (d) => d[1]},
    {"name": "table_list$ebnf$1", "symbols": ["table_list$ebnf$1$subexpression$1"]},
    {"name": "table_list$ebnf$1$subexpression$2", "symbols": ["ws", "table"], "postprocess": (d) => d[1]},
    {"name": "table_list$ebnf$1", "symbols": ["table_list$ebnf$1", "table_list$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "table_list", "symbols": ["table_list$ebnf$1", "ws"], "postprocess": (d) => d[0]},
    {"name": "table", "symbols": ["open_block", "ws", "table_headers", "close_block"], "postprocess": (d) => { return { headers: d[2] } }},
    {"name": "table_headers$ebnf$1", "symbols": []},
    {"name": "table_headers$ebnf$1", "symbols": ["table_headers$ebnf$1", "table_header"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "table_headers", "symbols": ["table_headers$ebnf$1"], "postprocess": id},
    {"name": "table_header", "symbols": ["header_title", "header_separator", "text_line", "eol"], "postprocess": (d) => { return { title: d[0], text: d[2] }; }},
    {"name": "header_title", "symbols": ["header_prefix", "identifier"], "postprocess": (d) => d[0] + d[1]},
    {"name": "header_prefix$string$1", "symbols": [{"literal":"h"}, {"literal":"e"}, {"literal":"a"}, {"literal":"d"}, {"literal":"e"}, {"literal":"r"}, {"literal":"-"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "header_prefix", "symbols": ["header_prefix$string$1"], "postprocess": id}
]
  , ParserStart: "main"
}
